...
public class RectBeanInfo extends SimpleBeanInfo{
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            PropertyDescriptor _myWidth = new PropertyDescriptor("myWidth", beanClass, "getMyWidth", "setMyWidth");

            _myWidth.setPropertyEditorClass(FiftyToThreeHundredEditor.class);

            PropertyDescriptor _myHeight = new PropertyDescriptor("myHeight", beanClass, "getMyHeight", "setMyHeight");
            ...
            PropertyDescriptor _myFill = new PropertyDescriptor("myFill", beanClass, "getMyFill", "setMyFill");

            _myFill.setPropertyEditorClass(TrueFalseEditor.class);

            PropertyDescriptor[] pds = new PropertyDescriptor[]{_myXStart,_myYStart,_myWidth,_myHeight, _myForeColor, _myBackColor,_myFill};
